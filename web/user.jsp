                            ...
                            <div class="table-responsive">
                                <form method="POST" action="ModificarDatos">
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <input type="text" class="input-group-text" placeholder="Nombre" value="<%=u.getNombre()%>">
                                            </div>
                                            <div class="col-4">
                                                <input type="text" class="input-group-text" placeholder="Apellido paterno" value="<%=u.getApPat()%>">
                                            </div>
                                            <div class="col-4">
                                                <input type="text" class="input-group-text" placeholder="Apellido materno" value="<%=u.getApMat()%>">
                                            </div>    
                                        </div>
                                        <br>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <input type="date" class="input-group-text" style="width: 250px" value="<%=u.getfNac()%>" name="fechaNacimiento">
                                            </div>
                                            <div class="col-4">
                            ...
                            <div class="table-responsive">
                                <form method="POST" action="ModificarCuenta">
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <input type="text" class="form-text" placeholder="Correo electrónico">
                                            </div>
                                            <div class="col-4">
                                                <input type="text" class="form-text" placeholder="Nombre de usuario">
                                            </div>
                                            <div class="col-4">
                                                <input type="text" class="form-text" style="width: 220px" placeholder="Correo electrónico">
                                            </div>
                                        </div>
                                    </div>
                                </form>
