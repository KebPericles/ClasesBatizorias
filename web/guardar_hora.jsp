...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        try{
            ...
            try{
                ...
                int nombre = Integer.parseInt(request.getParameter("id"));
                int hora = Integer.parseInt(request.getParameter("hora"));
                String ciudad = request.getParameter("dias");
                ...
                String sql = "insert into horarios values ('"+i+"','"+nombre+"','"+hora+"','"+ciudad+"','"+duracion+"'  )";
    ...
    %>
        <h1>Muchas gracias por ser registro :3</h1>
        <a href="index.html" >
            Regresar al Menu
        </a>
        <br>
        <a href="crear_hora.jsp">
            Insertar otro horario
        </a>
    </body>
